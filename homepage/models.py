...
BANK_NAME_CHOICES = (('국민은행', '국민은행'), ('신한은행', '신한은행'), ('우리은행', '우리은행'), ('하나은행', '하나은행'),
                     ('케이뱅크', '케이뱅크'), ('카카오뱅크', '카카오뱅크'), ('산업은행', '산업은행'), ('기업은행', '기업은행'), ('한국수출입은행', '한국수출입은행'),
                     ('농협은행', '농협은행'), ('신협은행', '신협은행'), ('대구은행', '대구은행'), ('부산은행', '부산은행'), ('경남은행', '경남은행'),
                     ('광주은행', '광주은행'), ('전북은행', '전북은행'), ('제주은행', '제주은행'))
